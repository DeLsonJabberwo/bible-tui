...
This is a TUI for reading the bible.  Fully FOSS.  Uses only public domain bible translations.  Written in Go, using [charmbracelet/bubbletea](https://github.com/charmbracelet/bubbletea).
